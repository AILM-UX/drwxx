...
def train_one_epoch(model, optimizer, data_loader, device, epoch):
    ...
    std_loss=std_loss1+std_loss2+std_loss3

    std_loss1=std_loss1/std_loss
    std_loss2=std_loss2/std_loss
    std_loss3=std_loss3/std_loss
...
if __name__ == '__main__':
    ...
    tb_writer = SummaryWriter("MQTransformer_Scaling Loss")
    ...
    for epoch in range(epoch_num):
        ...
        if train_acc1>best_train_acc:
            torch.save(model, 'MQTransformer_Scaling Loss.pth')
